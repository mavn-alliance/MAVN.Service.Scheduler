...
namespace MAVN.Service.Scheduler
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "SchedulerLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.SchedulerService.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("Scheduler", channelOptions =>
                        {
